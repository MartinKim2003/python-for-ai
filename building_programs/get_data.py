...
url = f"https://api.open-meteo.com/v1/forecast?latitude=-34.60&longitude=-58.38&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Buenos Aires Weather - Past Week')
plt.legend()
